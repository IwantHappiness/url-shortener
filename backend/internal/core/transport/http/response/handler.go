...
func (h *HTTPResponseHandler) JSONResponse(responsBody any, statusCode int) {
	h.w.WriteHeader(statusCode)

	if err := json.NewEncoder(h.w).Encode(responsBody); err != nil {
...
func (h *HTTPResponseHandler) PanicHandler(p any, msg string) {
	statusCode := http.StatusInternalServerError
